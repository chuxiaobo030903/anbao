...
const Index: any = () => {
  ...
  return (
    <>
      <div className="mt10 xindex">
        首页 {_mobx.xMobxValue}
        <div className="xcol-box">
          <div className="xflex" onClick={() => { NToXtest() }}>
            goto Xtest
          </div>
          <div className="xflex mt30 mb30" onClick={() => {NToLogin()}}>
            goto login
          </div>
          <div className="xflex" onClick={() => { _mobx.setXmobxValue("双向绑定改变mobx变量值") }}>
            2222222
          </div>
        </div>
        <div className="f30">
